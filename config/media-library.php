...
return [
    ...
    'custom_path_generators' => [
        ...
        Category::class => App\Helpers\ModelPathGenerator::class,
        Course::class => App\Helpers\ModelPathGenerator::class,
        Lesson::class => App\Helpers\ModelPathGenerator::class,
        PageBlock::class => App\Helpers\ModelPathGenerator::class,
        SiteSetting::class => App\Helpers\ModelPathGenerator::class,
    ],
